...
export default class DecorationStorePurchaseModal extends Modal {
  ...
  oninit(vnode) {
    ...
    this.backgroundUrl = Stream(this.tagData.attribute("zivenBackgroundURL"));
  }
  ...
  title() {
    return app.translator.trans('ziven-tag-background.admin.set-background');
  }
      ...
      <div className="Modal-body">
        <div className="Form">
          <div className="Form-group" style="text-align: center;">
              <div className="ModuleItemSettingsLabel">{app.translator.trans('ziven-tag-background.admin.item-background-url')}</div>
          ...
          <div className="Form-group" style="text-align: center;">
            {Button.component(
              ...
              app.translator.trans('ziven-custom-index-page.lib.save')
            )}&nbsp;
            {Button.component(
              {
              ...
              app.translator.trans('ziven-custom-index-page.lib.cancel')
            )}
          </div>
        </div>
      </div>
